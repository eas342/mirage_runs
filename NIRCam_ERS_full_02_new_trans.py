...
print("New Input Data Path: {}".format(input_data_path))
...
print("output yaml: {}".format(output_yaml_dir))
...
print("output data dir: {}".format(output_data_dir))
...
xml_file = os.path.join(input_data_path,'input_013_full_ers', 'ERS_WASP43_full.xml')
...
import mirage.utils
reload(mirage.utils)
reload(mirage.grism_tso_simulator)
from mirage.grism_tso_simulator import GrismTSO
