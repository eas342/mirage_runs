...
# # Create NIRCam TSO Simulated Data - extra short SET for ERS Data Challenge
...
## tried to manually edit the XML
xml_file = os.path.join(input_data_path,'input_010_shorter_still_ers', 'ERS_WASP43_even_shorter.xml')
...
params.t0 = 4320.                        # time of inferior conjunction (This one is just offset from start)
...
times = np.linspace(0, 2.5 * 3600., 1000)  # times at which to calculate light curve 
...
#yaml.safe_load(open(gr_tso_yaml_file))
